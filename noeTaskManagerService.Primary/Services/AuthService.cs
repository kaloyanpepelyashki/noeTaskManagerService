        ...
        */
        public async Task<User?> SignIn(string email, string password)
        {
            ...
            {  
                ...
                {
                    throw new AuthException("No valid credentials were provided");
                }
        ...
        public async Task<User?> SignUp(string firstName, string lastName, string email, string hashedPassword)
        {
            try
            {
                if (String.IsNullOrWhiteSpace(email) || String.IsNullOrWhiteSpace(hashedPassword) || String.IsNullOrWhiteSpace(firstName) || String.IsNullOrWhiteSpace(lastName))
                {
                    throw new AuthException("No valid credentials were provided");
                }
